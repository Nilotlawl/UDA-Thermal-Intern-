...
class CNNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self. ShuffleAttention1 =  ShuffleAttention(128) #128 for digit 256 for alpha
        self. ShuffleAttention2 =  ShuffleAttention(64) # 64 for digit 128 for alpha
