...
class CNNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.CoTAttention1 = CoTAttention(128) #128 for digit 256 for alpha
        self.CoTAttention2 = CoTAttention(64) # 64 for digit 128 for alpha
